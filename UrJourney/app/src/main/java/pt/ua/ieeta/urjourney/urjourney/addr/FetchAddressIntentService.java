package pt.ua.ieeta.urjourney.urjourney.addr;
...
import pt.ua.ieeta.urjourney.urjourney.OpenWeatherMap;
...
public class FetchAddressIntentService extends IntentService
{
    ...
    protected void onHandleIntent(Intent intent)
    {
        ...
        // If it wasn't, send an error error message and return.
        if (location == null)
        {
        ...
        else
        {
            ...
            {
                Log.i(TAG, getString(R.string.address_found));
                deliverResultToReceiver(Constants.SUCCESS_RESULT, pais);
            }
