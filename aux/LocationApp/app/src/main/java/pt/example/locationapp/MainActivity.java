package pt.example.locationapp;
...
public class MainActivity extends AppCompatActivity
{
    ...
    /*private void showAlert()
    {
        ...
        final String dialogTitle = "Enable Location";
        final String dialogMsg = "Your Locations Settings is set to 'Off'.\nPlease Enable Location to use this app";
        final String dialogGoBtn = "Location Settings";
        final String dialogCancelBtn = "Location Settings";

        final Context context = getApplicationContext();
        final String toast = "Failed to connect to GPS";
        final int duration = Toast.LENGTH_SHORT;

        dialog.setTitle(dialogTitle)
                .setMessage(dialogMsg)
                .setPositiveButton(dialogGoBtn, new DialogInterface.OnClickListener()
                {
                    @Override
                ...
                .setNegativeButton(dialogCancelBtn, new DialogInterface.OnClickListener()
                {
                    @Override
                    public void onClick(DialogInterface paramDialogInterface, int paramInt)
                    {
