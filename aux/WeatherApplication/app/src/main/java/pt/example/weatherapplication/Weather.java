...
public class Weather
{
    ...
    {
        //void processFinish(String output1, String output2, String output3, String output4, String output5, String output6, String icon);
        void processFinish(String output1, String output2, String output3, String output4, String output5, String output6, String iconUrl);
    }
        ...
        protected void onPostExecute(JSONObject json)
        {
            try
            {
                if (json != null)
                {
                    ...
                    Log.i("PostExecute: ", "--> msg: " + city + "<-----");
                    Log.i("PostExecute: ", "--> msg: " + description + "<-----");
                    Log.i("PostExecute: ", "--> msg: " + temperature + "<-----");
